<?php
// Purpose: Display all saved orders from orders.txt
...
<body>
  <div class="container">
    <h1>Saved Orders</h1>
    <?php if (empty($lines)): ?>
      <div class="empty">⚠️ No orders found. Please place an order first.</div>
    <?php else: ?>
      <table>
        <thead><tr><th>#</th><th>Order Summary</th></tr></thead>
        <tbody>
    ...
    <?php endif; ?>
    <a href="order_calculator.php" class="btn">← Back to Calculator</a>

    <p class="footer-note">
      © <?php echo date("Y"); ?> LYOIDEV Online Product Order System | All Rights Reserved
    </p>
  </div>
</body>
</html>
